...
public class ApiErrorResponse {
    ...
    public ApiErrorResponse(String type, String title, int status, String detail, String instance, List<FieldError> fieldErrors) {
        this.type = type;
        this.title = title;
        this.status = status;
        this.detail = detail;
        this.instance = instance;
        this.fieldErrors = fieldErrors != null ? fieldErrors.stream()
